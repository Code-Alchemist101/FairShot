...
# FairShot - Project Setup Script
# This script initializes the monorepo structure

set -e  # Exit on error

echo "🚀 FairShot - Project Setup"
echo "============================"
echo ""
...
echo -e "${BLUE}🔧 Initializing NestJS backend...${NC}"
cd apps/api

# Create package.json for NestJS
cat > package.json << 'EOF'
{
  "name": "fairshot-api",
  "version": "1.0.0",
  "description": "FairShot Backend API",
  "author": "FairShot Team",
  "private": true,
  "license": "UNLICENSED",
  "scripts": {
    "build": "nest build",
...
# Create NestJS source structure
mkdir -p src
cat > src/main.ts << 'EOF'
...
AWS_S3_BUCKET=fairshot-uploads
...
echo -e "${GREEN}✓ NestJS backend initialized${NC}"
cd ../..
echo ""

# Initialize Next.js Frontend
echo -e "${BLUE}⚛️  Initializing Next.js frontend...${NC}"
cd apps/web
...
echo -e "${GREEN}✓ Next.js frontend initialized${NC}"
cd ../..
echo ""
...
echo "   ${GREEN}cd apps/api && npm install${NC}"
echo "   ${GREEN}cd ../web && npm install${NC}"
echo ""
echo "3. Copy the Prisma schema:"
echo "   ${GREEN}cp prisma/schema.prisma apps/api/prisma/schema.prisma${NC}"
echo ""
echo "4. Generate Prisma client and run migrations:"
echo "   ${GREEN}cd apps/api${NC}"
echo "   ${GREEN}npx prisma generate${NC}"
echo "   ${GREEN}npx prisma migrate dev --name init${NC}"
echo ""
echo "5. Start development servers:"
echo "   ${GREEN}cd apps/api && npm run start:dev${NC} (Terminal 1)"
echo "   ${GREEN}cd apps/web && npm run dev${NC} (Terminal 2)"
echo ""
